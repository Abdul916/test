...
.other_pages.header-three .main-header .nav-main ul li a{
  color: #006bb9;
}
...
.header-three.header--sticky.sticky .main-header .nav-main ul li a{
  color: #006bb9;
}
.icon.map-icon{
  width: 90px;
...
.header--sticky.sticky .plan-logo,.header--sticky .sticky-logo{
 display: none;
}
...
.bg_banner-three {
/*  background-image: url(../images/section-bg-hero2-1.png);*/
position: relative;
z-index: 1;
width: 100%;
}
...
.pricing-wrapper-one .pricing-body .single-pricing .icon i:before {
  color: white;
}
...
@media only screen and (max-width: 767px) {
  ...
  .rts-callto-acation-area .rts-btn{
    font-size: 15px;
  }
}
@media only screen and (max-width: 575px) {
...
.loader-wrapper {
  ...
  --outer-line-color: #0097db;
  --middle-line-color: #006bb9;
  --inner-line-color: #0158a9;
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
@media only screen and (max-width: 575px) {
  ...
  .main-header-three a.thumbnail-logo img {
    /*min-height: 100px;*/
    object-fit: contain;
}
}
...
.swiper-pagination-bullet.swiper-pagination-bullet-active {
  background-color: #1F3EC1 !important;
}

.header-three-blue {
  background-color: #0158a9 !important;
}
...
.index_page .xl_search_first {
  display:flex;
  justify-content:center;
  font-size: 50px !important;
  padding: 35px 0px;
}
.index_page .xl_search_first p{
  width: 60%;
}
.index_page .xl_search_first .search_input_field{
  width:40%;
}
.index_page .xl_search_first .search_input_field .form-control{
  display:flex;
  flex-wrap:wrap;
  width:50%;
  margin:0 auto;
...
.index_page .xl_search_first .search_input_field .btn{
  width:20%;
  font-size: 18px !important;
}
.school_page .search_input_field{
  display:flex;
  flex-wrap:wrap;
  width:50%;
  margin:0 auto;
...
.school_page .search_input_field .btn{
  width:20%;
  font-size: 18px !important;
}
@media (max-width:1200px){
...
.rts-team-details .title-area .title {
...
.rts-team-details .terms_policy_main {
    padding: 0 !important;
}
...
.complete_guide .banner-three-inner > ul > li {
  list-style: none;
}
.complete_guide h2 {
  font-size: 25px;
}
.complete_guide li::marker {
  color: #0158a9 !important;
}
.complete_guide h3 {
  font-size: 20px;
...
.bg-input-project .product-form select {
  background: #ffff;
  border-radius: 15px;
  height: 55px;
  border: 1px solid transparent;
...
.bg-input-project .product-form select:focus {
  border: 1px solid var(--color-primary-3);
}
