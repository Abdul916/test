...
$recaptcha_secret = '6Ldd2GUmAAAAABjqu1uICKTsBO4cK4NLUm5K9ENc';
...
if (!$response_data->success) {
    if (isset($error_message)) {
        header('Location: http://www.clarktransportationsolutions.com/contact.php?error=reCAPTCHA');
        exit();
    }
    exit();
}
...
if ( $validationFailed === false ) {
        # Email to Form Owner
    $emailSubject = FilterCChars("Contact Request From Clark Transportation Solutions");
    $emailBody = "" . date('Y-m-d H:i:s') . "\n"
    . "\n"
    . "Scott,\n"
    . "\n"
    . "A contact request has been submitted to the Clark Transportation website.  The details follow:\n"
    . "\n"
    . "CONTACT INFORMATION\n"
    . "===================\n"
    . "\n"
    ...
    $confEmailBody = chunk_split( base64_encode( "" . date('m/d/y') . "\n"
        ...
        . "Phone: 480-347-9765\n"
        . "Fax: 480-284-7628" ) );
    $confEmailHeader = "From: Clark Transportation Solutions <info@clark-inc.com>\n"
    . "MIME-Version: 1.0\n"
    . "Content-type: text/plain; charset=\"ISO-8859-1\"\n"
    . "Content-transfer-encoding: base64\n";
    mail($confEmailTo, $confEmailSubject, $confEmailBody, $confEmailHeader);
        # Redirect user to success page
    header("Location: http://www.clarktransportationsolutions.com/success.php");
}
?>